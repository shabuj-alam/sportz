<div align="center">
  <h3 align="center">Sports Events API with Websockets</h3>
  <div>
...
```bash
git clone https://github.com/shabujalam/sportz.git
cd sportz
```
...
```json
{
  ...
  "startTime": "2025-02-27T12:00:00.000Z",
  "endTime": "2025-02-27T13:45:00.000Z"
}
```
